    ...
    <>
      <div className="container w-full mt-5 ">
        <div className="row flex justify-evenly">
          <div className="email flex text-white p-2 shadow-xl rounded-lg hover:bg-white hover:scale-105 transition duration-[0.3s] relative hover:cursor-pointer hover:text-black">
