...
const Contact_Icon = () => {
  ...
  return (
    <div className="flex items-center ml-0 mt-6 rounded-full space-x-4 sm:justify-start  m-auto">
      
      {/* WhatsApp icon */}
      <div className="cursor-pointer text-white hover:scale-105 transition duration-[0.3s]  hover:text-green-700  text-center ml-3 border-none  bg-emerald-850 rounded-lg shadow-md  p-2" style={{boxShadow: '0 4px 5px 5px rgba(0, 0, 0, 0.4)'}}>
        <FontAwesomeIcon icon={faWhatsapp} className="text-xl" onClick={() => openWhatsApp('+9893785834')} />
      </div>
  
      {/* Mail icon */}
      <div className="cursor-pointer text-white hover:scale-105 transition duration-[0.3s]  hover:text-red-700 text-center ml-3 border-none   bg-emerald-850 rounded-lg shadow-md  p-2" style={{boxShadow: '0 4px 5px 5px rgba(0, 0, 0, 0.4)'}}>
        <FontAwesomeIcon icon={faEnvelope} className="text-xl" onClick={() => openMail('mailto:komalprajapat267@mail.com')} />
      </div>
  
      {/* Facebook icon */}
      <div className="cursor-pointer text-white hover:scale-105 transition duration-[0.3s]  hover:text-blue-700 text-center ml-3 border-none  bg-emerald-850 rounded-lg shadow-md p-2" style={{boxShadow: '0 4px 5px 5px rgba(0, 0, 0, 0.4)'}}>
        <FontAwesomeIcon icon={faFacebook} className="text-xl" onClick={() => openFacebook()} />
      </div>
  
      {/* Instagram icon */}
      <div className="cursor-pointer text-white hover:scale-105 transition duration-[0.3s]  hover:text-pink-700 text-center ml-3 border-none  bg-emerald-850 rounded-lg shadow-md  p-2" style={{boxShadow: '0 4px 5px 5px rgba(0, 0, 0, 0.4)'}}>
